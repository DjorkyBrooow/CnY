...
<body>
	...
	<div class="container container-panier">
			...
			<form action="modifierutilisateur">
				<div>
					<label for="prenom">Prénom</label> <input type="text" name="prenom"
						id="prenom" placeholder="Nouveau prénom">
				</div>
				<div>
					<label for="email">Email</label> <input type="email" name="email"
						id="email" placeholder="Nouvel e-mail">
				</div>
				<div>
					<label for="ancienmdp">Ancien mot de passe</label> <input
						type="password" name="ancienmdp" id="ancienmdp"
		...
		<div class="button-panier divcompte">
			<a class="mx-3 btn button-table" href="historique.jsp">Voir mes
				anciennes commandes</a>
		</div>
