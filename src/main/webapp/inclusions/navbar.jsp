...
<nav class="navbar navbar-expand-lg">
	<div class="container-fluid">
		...
		<a class="navbar-brand" href="index.jsp"><img id="logo"
			alt="logo cny" src="img/CnY_Logo.png"></a>
		...
		<div class="collapse navbar-collapse" id="navbarSupportedContent">
			<ul class="navbar-nav ms-auto mb-2 mb-lg-0">
				...
				<li class="nav-item"><a class="nav-link" href="monCompte.jsp">Mon
						compte</a></li>
				<li class="nav-item log"><a class="nav-link" href="logout">Déconnexion</a></li>
				<%
				} else {
				%>
				<li class="nav-item log"><a class="nav-link" href="login.jsp">Inscription/Connexion</a></li>
				<%
				}
				%>
			</ul>
